...
-- Create employee_salary table with foreign keys and UNIQUE
...
(2, 'Ron', 'Swanson', 49, 'Male', '1976-01-01'), -- Needed for foreign key to match
(69, 'Anurag', 'Mankapure', 22, 'Male', '2002-01-01'); -- Added for completeness
...
(69, 'Anurag', 'Mankapure', 'Student', NULL, NULL);
